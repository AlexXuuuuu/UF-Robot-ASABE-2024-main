...
def generate_launch_description():
    ...
    # map_yaml_file = LaunchConfiguration("map_yaml_file") # global map for navigation
    # pkg_world_file = LaunchConfiguration("pkg_world_file") # launch the gz sim in turtlebot world
    ...
    rviz = Node(
        ...
        arguments=[
            "-d",
            os.path.join(get_package_share_directory("sam_bot_nav2_gz_moveit_config"), "config", "moveit.rviz"),
        ],
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("sam_bot_nav2_gz_moveit_config"),
        "config",
