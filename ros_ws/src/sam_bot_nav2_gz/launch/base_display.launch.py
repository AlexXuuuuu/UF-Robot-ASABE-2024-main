...
import launch_ros
import os
from launch_ros.parameter_descriptions import ParameterValue # used to wrap the robot description and define type as string
...
def generate_launch_description():
    ...
    default_model_path = os.path.join(
        pkg_share, "src/description/robot_description_base.urdf"
    )
